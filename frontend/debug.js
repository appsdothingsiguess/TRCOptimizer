...
function setBadge(tileId, state) {
...
function updateHealth(debugState, backendHealth, relayFetchOk) {
...
function updateLastIntake(result) {
...
function appendLogRow(container, entry, source, scroll) {
...
function replaceLog(containerId, entries, source) {
...
async function refresh() {
    ...
    let backendHealth = { fastApiUp: false };
